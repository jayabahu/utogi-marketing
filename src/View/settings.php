...
if (!function_exists("marketing_settings_page")) {
    function marketing_settings_page()
    {
        ...
        <h2 class="nav-tab-wrapper">
            <a href="?page=utogi_settings&tab=setup"
                class="nav-tab <?php echo $activeTab == 'setup' ? 'nav-tab-active' : ''; ?>">Setup</a>
            <a href="?page=utogi_settings&tab=import"
                class="nav-tab <?php echo $activeTab == 'import' ? 'nav-tab-active' : ''; ?>">Import</a>
            <a href="?page=utogi_settings&tab=webhook"
                class="nav-tab <?php echo $activeTab == 'webhook' ? 'nav-tab-active' : ''; ?>">Webhook</a>
        </h2>
        <?php settings_errors(); ?>

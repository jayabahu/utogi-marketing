<div class="property_details_box">
       ...
       <section>
              ...
              <div class="meta-options property_details_field">
                     ...
                     <input id="priceDate" type="text" name="priceDate"
       ...
       <section>
              ...
              <div class="meta-options property_details_field">
                     ...
                     <input id="bathrooms" type="text" name="bathrooms"
              ...
              <div class="meta-options property_details_field">
                     ...
                     <input id="ensuites" type="text" name="ensuites"
       ...
       <section>
              <div class="meta-options property_details_field">
                     ...
                     <input id="featuredImages" type="text" name="featuredImages"
       ...
       <section>
              <div class="meta-options property_details_field">
                     ...
                     <input id="agents" type="text" name="agents"
